...
TOKEN = os.environ.get('8158874437:AAHPPL-03-seImkmAf7umfJGGC0PxXPL8Uo')
...
def calculate_price(brawler_name: str, current_trophies: int, desired_trophies: int) -> float:
    ...
    multiplier = 0.3
    hard_brawlers = [
        "мортис", "пайпер", "мэг", "бонни", "динамайк", "кольт", "гром", "базз", "корделиус", "роза", "8-бит",
        "белль", "финкс", "нани", "R-T"
    ]

    very_hard_brawlers = [
        "спайк", "амбер", "честер", "мелоди", "сэнди", "тик"
    ]
